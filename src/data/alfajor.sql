...
INSERT INTO `categoria` VALUES (1,26,'alfjores'),(2,26,'alfjores'),(3,0,'alfajores - prueba'),(4,26,'alfjores'),(5,26,'alfjores'),(6,26,'alfjores'),(7,0,'alfjores prueba miercoles'),(8,26,'alfjores'),(9,26,'alfjores'),(10,26,'alfjores'),(11,26,'alfjores'),(12,26,'alfjores'),(13,26,'alfjores'),(14,26,'alfjores'),(15,26,'alfjores'),(16,26,'alfjores'),(17,26,'alfjores'),(18,26,'alfjores'),(19,26,'alfjores'),(20,26,'alfjores'),(21,26,'alfjores'),(22,26,'alfjores'),(23,26,'alfjores'),(24,26,'alfjores'),(25,26,'alfjores'),(26,26,'alfjores prueba'),(27,26,'alfjores'),(28,26,'alfjores');
...
INSERT INTO `cliente` VALUES (1,2,'0','javier','castillo','11','4545','22222'),(2,2,'0','javier eduardo','castillo lopes','11','4545','22222'),(3,1,'','cliente prueba martes','jhjjklkuiooio','22','7845454','54545454'),(4,3,'0','nombre prueba martes2','apellido  prueba martes2','55','77777777','123456'),(5,1,'0','jose','carbajal','10','+51 88888888','4456789');
...
INSERT INTO `detallepedido` VALUES (1,15,2,2,4.00),(2,19,2,3,5.00),(3,19,3,1,5.00),(4,24,3,1,3.00),(5,13,4,2,7.00),(6,20,4,1,11.00);
...
INSERT INTO `membresia` VALUES (1,'CLASICA'),(2,'PLATA'),(3,'ORO'),(4,'BLACK');
...
CREATE TABLE `pedido` (
  ...
  `pedido_fecha` timestamp NULL DEFAULT current_timestamp(),
...
INSERT INTO `pedido` VALUES (2,2,NULL,'2022-11-22 20:35:42',23.00),(3,3,NULL,'2022-11-22 21:11:20',8.00),(4,5,NULL,'2022-11-22 21:26:51',25.00);
...
INSERT INTO `producto` VALUES (13,1,'Trufas - Caja x 10',7.45,14.90,13),(14,1,'Biscrut Copa - Manjar',0.00,10.90,2),(15,1,'Alfajor Tradicional - Personal redondo',4.72,5.90,34),(16,1,'Caja De Alfajores 1 Sabor - Pecana x 16 und',16.20,18.90,3),(17,1,'Pionono - Tradicional con manjar blanco chico',0.00,19.90,10),(18,1,'Pionono - Sabor a chocolate con fudge personal',6.58,7.90,3),(19,1,'Caf? - Capuccino',5.93,7.90,11),(20,1,'Alfa Pack - Chocolate x 20',11.67,14.00,2),(21,1,'Caja De Alfajores 2 Sabores - Tradicional / Casta?a x 10 und',7.93,11.90,2),(22,1,'Chif?n - Sabor a Naranja Grande',16.58,19.90,14),(23,1,'Bolsas De Tela - Chica',5.20,6.50,8),(24,1,'Caja De Alfajores 1 Sabor - Tradicional x 20 und',0.00,18.90,81),(25,1,'producto prueba elias',5.00,7.00,NULL),(26,7,'gaseosa',3.00,8.00,NULL),(27,3,'77777777',7.00,2.00,NULL);
...
INSERT INTO `usuario` VALUES (1,'elias','123'),(2,'admin','123456');
/*!40000 ALTER TABLE `usuario` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'algoritmos_casa_alfajor'
--

--
-- Dumping routines for database 'algoritmos_casa_alfajor'
--
/*!50003 DROP PROCEDURE IF EXISTS `sp_findAll_Categoria` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_findAll_Categoria`()
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS `sp_findAll_Cliente` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_findAll_Cliente`()
select c.cliente_id,c.dni, c.cliente_nombres, c.cliente_apellidos, m.membresia_nombre, c.cliente_edad, c.cliente_telefono from cliente c, membresia m where c.membresia_id = m.membresia_id ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_findAll_Pedido` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_findAll_Pedido`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_findAll_Producto` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_findAll_Producto`()
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_findAll_Usuario` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_findAll_Usuario`()
select * from usuario ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_find_Categoria`(in categoria_id int)
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_find_Cliente`(in cliente_id int)
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_find_Cliente_Criterio` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_find_Detallepedido` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_find_Detallepedido`(in idpedido int)
BEGIN
select  d.producto_id, p.producto_nombre,d.detallepedido_cantidad,d.detallepedido_precio from detallepedido d inner join producto p on d.producto_id = p.producto_id where d.pedido_id=idpedido;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_find_Producto`(in producto_id int)
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_find_Usuario`(in pusuario varchar(50), in pclave varchar(50))
BEGIN
select * from usuario where nombre=pusuario and password=pclave;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_Categoria`(in categoria_categoriaid int,in categoria_nombre varchar(45))
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_Cliente`(in membresia_id int, in cliente_orden varchar(45), in cliente_nombres varchar(45), in cliente_apellidos varchar(45),
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_DetallePedido`(in pedido_id int,in producto_id int,in cantidad int,in precio decimal(10,2))
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_Pedido`( in pclienteid int, in ptotal decimal(10,2),INOUT pedido_id int)
BEGIN
insert into pedido(cliente_id,pedido_fecha,pedido_total) values (pclienteid,NOW(),ptotal);
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_Producto`(in categoria_id int,in producto_nombre varchar(45),producto_costo decimal(10,2), producto_precio decimal(10,2))
insert into producto(categoria_id,producto_nombre,producto_costo,producto_precio ) values (categoria_id,producto_nombre,producto_costo,producto_precio) ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_Usuario`(in pnombre varchar(45),in ppass varchar(45))
BEGIN
insert into usuario(nombre ,password) values (pnombre,ppass);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_Categoria`(in pcategoria_id int, in categoria_categoriaid int,in categoria_nombre varchar(45))
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_Cliente`(in pcliente_id int, in pmembresia_id int, in pcliente_orden varchar(45), in pcliente_nombres varchar(45), 
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_Producto`(in producto_id int, in categoria_id int,in producto_nombre varchar(45),producto_costo decimal(10,2), producto_precio decimal(10,2))
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_Usuario`(in pidusuario int,in pnombre varchar(45),in ppass varchar(45))
BEGIN
update usuario set nombre=pnombre,password=ppass where idusuario=pidusuario;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2022-12-10 15:26:13
